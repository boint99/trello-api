...
export const env = {
  ...
  WEBSITE_DOMAIN_DEVELOMENT: process.env.WEBSITE_DOMAIN_DEVELOMENT,
  ...
  CLOUDINARY_CLOUDE_KEY: process.env.CLOUDINARY_CLOUDE_KEY,
  CLOUDINARY_CLOUDE_SECRET: process.env.CLOUDINARY_CLOUDE_SECRET
}
